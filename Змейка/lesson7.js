...
function haveFood(unit) {
    ...
    var scoreCount = document.querySelector('.total-score');
...
function createObstacle() {
    ...
    setTimeout(removeObstacle, 4000);

}

function removeObstacle() {
    obstacleCell = document.querySelector('.obstacle-unit');
    obstacleCell.classList.remove('obstacle-unit');
}
